...
Zeitstrahl is event-sourced by design. The definitions in this ADR and the
...
deployment defaults do not belong in Zeitstrahl. Documentation and APIs qualify
