...
Zeitstrahl will expose domain descriptors, stream inspection, state
...
Zeitstrahl Studio and AI-facing adapters, including a possible MCP server, are
...
Zeitstrahl kernel and adapters.
