...
pub fn expand(input: &DeriveInput) -> syn::Result<TokenStream> {
    ...
    let runtime = crate::helper::runtime_api_path::resolve_optional()?
        .map_or_else(TokenStream::new, |runtime_path| {
            super::runtime::assemble(&domain_path, &runtime_path, &input.ident)
        });
    Ok(quote::quote! {
        #descriptor
        #runtime
