use domain::{PolicyDescriptor, PolicyId, PolicyOutcome, PolicyOutcomeType, domain_policy};

#[derive(Debug, PolicyOutcome, Eq, PartialEq)]
...
#[domain_policy(id = "assess-eligibility", label = "Assess eligibility")]
...
fn annotated_trait_keeps_ordinary_behavior_and_global_metadata() {
    ...
    assert_eq!(
        ...
        PolicyDescriptor {
            id: PolicyId("assess-eligibility"),
...
#[test]
fn policy_outcomes_retain_intrinsic_ordered_metadata() {
    let outcomes = <EligibilityOutcome as PolicyOutcomeType>::OUTCOMES;
