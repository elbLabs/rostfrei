...
pub use rostfrei_registry::{
    ...
    DomainRegistry, ModuleDescriptor, QueryDefinition,
    QueryDescriptor as QueryRegistrationDescriptor, RegistrationError,
};

#[doc(hidden)]
pub mod __private {
    pub use domain::__private::{
        AggregateActionOutput, AttachedDecisionGroup, DomainIdentityDescriptor, DomainIdentityType,
        DomainServiceActionOutput, EntityActionOutput, SameType, ValueObjectActionOutput,
        emit_domain_test_descriptor, serde, serde_json,
    };
